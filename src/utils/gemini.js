...
Buatkan 1 soal latihan interaktif dengan tema yang menarik dalam format JSON.

PILIH KESULITAN BERIKUT (Silakan sesuaikan sebelum mengirim):
- Tingkat Kesulitan: [beginner / intermediate / advanced]

TEMA OTOMATIS:
Anda WAJIB menentukan tema yang sesuai secara otomatis dan mandiri berdasarkan tingkat kesulitan (difficulty) yang diminta:
...
1. KELARASAN TEMA:
   - Teks soal harus berlatar belakang cerita/topik yang relevan dengan tema otomatis yang ditentukan di atas.
...
3. DRAFTING TERBALIK:
   - Buatlah teks bahasa Indonesia yang 100% BENAR secara EYD V terlebih dahulu (sesuai spesifikasi panjang dan kosakata di atas).
...
4. ATURAN PENULISAN SOAL & VARIASI KATEGORI:
   - Set soal harus mencampur variasi aturan EYD sesuai ketentuan di atas.
...
SKEMA OUTPUT JSON (KEMBALIKAN HANYA JSON INI SAJA):
{
  ...
  "title": "[Judul Menarik Soal]",
  "text": "[Teks sesuai spesifikasi tingkat kesulitan]",
  "italicWords": ["[daftar kata/frasa asing yang ditulis miring secara benar di teks, jika tidak ada isi []]"],
  "errors": [
    {
