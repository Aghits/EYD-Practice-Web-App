...
9. Bidang "italicWords" wajib berisi daftar kata atau frasa asing/daerah/ilmiah yang tertulis secara benar di dalam teks (tidak dianggap salah/error oleh user) agar sistem dapat menampilkannya dalam bentuk miring (italic). Jika tidak ada kata asing yang benar di dalam teks, isi dengan array kosong [].
